...
function s.spop1(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)~=0
		...
		local sg=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(s.spfilter),1-tp,LOCATION_GRAVE,0,1,1,nil,e,1-tp)
...
function s.spfilter2(c,e,tp)
	return c:IsSetCard(SET_ABHYSS) and c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
